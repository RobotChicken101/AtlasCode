...
const String ssid = "Kabeer";                                 //The name of the Wi-Fi network you are connecting to
const String pass = "password";                             //Your WiFi network password
const long myChannelNumber = 2196464;                            //Your Thingspeak channel number
const char * myWriteAPIKey = "WV5313MKZOYGXPLL";                 //Your ThingSpeak Write API Key
//------------------------------------------------------------------
